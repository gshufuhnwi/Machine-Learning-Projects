...
class LoadDataset:
        def __init__(self):
                ...
                self.datafiles = ['abalone.data','car.data','segmentation.data', 'machine.data',
                                 'forestfires.data', 'winequality-red.csv', 'winequality-white.csv', 'glass.data']
                self.datafiles = ['glass.data']
                self.alldataset = {}
        ...
        def IsClassificationDict(self):
                ...
                return {'abalone': True, 'car': True, 'segmentation': True, 'machine': False,
                        'forestfires': False, 'winequality-red': False, 'winequality-white': False, 'glass': True} 
        ...
        def get1sthiddenlayernode(self, key):
                ...
                dict_list = {'abalone': 100, 'car': 30, 'segmentation': 20, 'machine': 30,
                        'forestfires': 30, 'winequality-red': 30, 'winequality-white': 60, 'glass': 20}
        ...
        def get2ndhiddenlayernode(self, key):
                ...
                #best performance.
                dict_list = {'abalone': [40,40], 'car': [15,15], 'segmentation': [10, 10], 'machine': [15,15] ,
                        'forestfires': [15,15], 'winequality-red': [15,15], 'winequality-white': [25, 25], 'glass': [10,10]}
                return dict_list.get(key)

...
'''
Multilayer percepton class for feedforward neural net structure.
takes a network structure input and use Stochastic Gradient desent for 
learning the weights and biases. Use Backprop class instances to calculate
the gradient descent of mini batches and update the weights and bias. Uses argmax
to return the predicted output for classification and and the actual output value
for regression. 
'''
...
class MLP:
        ...
        def train(self, x_train, x_label, epoch, batch_size, eta, isClassification= True):
        ...
        def test_validation(self, validate_set, isClassification, epoch):
                ...
                if isClassification:       
                        ...
                        return rmse
        #Helper getter setter function for SAE class        
        def getWeights(self):
                return self.weights
